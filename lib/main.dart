...
// Auth state wrapper
// NOTE: Email verification is enforced in the signIn() function.
// The AuthWrapper just checks if a user is logged in.
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
      ...
      builder: (context, snapshot) {
        ...
        // (signIn function already ensures only verified users can log in)
        if (snapshot.hasData) {
